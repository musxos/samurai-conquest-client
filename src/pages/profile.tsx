            ...
            <div className="flex flex-col items-center w-full gap-4">
                <div className="bg-neutral-900/20 backdrop-blur-xl border border-violet-500/10 px-6 py-4 rounded-xl flex flex-col items-center w-full">
                    ...
                    <div className="flex flex-row gap-4">
                        <AgentCard assign={false} image={"1.png"} number={1} name="Test 1"></AgentCard>
                        <AgentCard assign={false} image={"2.png"} number={1} name="Test 2"></AgentCard>
                        <AgentCard assign={false} image={"3.png"} number={1} name="Test 3"></AgentCard>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className="flex flex-col gap-4">
                <div className="bg-neutral-900/20 backdrop-blur-xl border border-violet-500/10 px-6 py-4 rounded-xl w-full flex flex-col items-center">
                    ...
                    <div className="flex flex-col gap-4 mt-4 w-full">
                        <div className="flex flex-col">
                            ...
                            ><i className="ri-sword-fill text-lg mr-2"></i> <span className="text-sm">Kill Monster (2/10)</span></span>
                            <div className="h-2 rounded-full bg-neutral-700">
                                <div className="h-2 rounded-full bg-neutral-900 stats" style={{ maxWidth: "72%" }}></div>
                            </div>
                        </div>
                        <div className="flex flex-col">
                            <span className="flex items-center text-blue-500 mb-1"
                            ><i className="ri-shield-fill text-lg mr-2"></i> <span className="text-sm">Defend (1/100)</span></span>
                            <div className="h-2 rounded-full bg-neutral-700">
                                <div className="h-2 rounded-full bg-neutral-900 stats" style={{ maxWidth: "55%" }}></div>
                            </div>
                        </div>
                        <div className="flex flex-col">
                            <span className="flex items-center text-yellow-500 mb-1"
                            ><i className="ri-vip-crown-fill text-lg mr-2"></i> <span className="text-sm">Murder</span></span>
                            <div className="h-2 rounded-full bg-neutral-700">
                                <div className="h-2 rounded-full bg-neutral-900 stats" style={{ maxWidth: "72%" }}></div>
                            </div>
                        </div>
                ...
                <div className="bg-neutral-900/20 backdrop-blur-xl border border-violet-500/10 px-6 py-4 rounded-xl w-full flex flex-col items-center">
                    ...
                    <div className="flex flex-col gap-4 mt-4 w-full">
                        <div className="flex flex-col ">
                            <span className="flex items-center text-red-500 mb-1"
                            ><i className="ri-user-fill text-lg mr-2"></i> <span className="text-sm">New Agent (2/10)</span></span>
                            <div className="h-2 rounded-full bg-neutral-700">
                                <div className="h-2 rounded-full bg-neutral-900 stats" style={{ maxWidth: "72%" }}></div>
                            </div>
                        </div>
                        <div title="Take your giveaway" className="flex flex-col hover:bg-neutral-700 rounded-xl cursor-pointer">
                            <span className="flex items-center text-blue-500 mb-2"
                            ><i className="ri-shield-fill text-lg mr-2"></i> <span className="text-sm">Capture The World</span></span>
                            <div className="h-2 mb-2 rounded-full bg-neutral-700">
                                <div className="h-2 rounded-full bg-green-500 stats" style={{ maxWidth: "100%" }}></div>
                            </div>
                        </div>
                    </div>
                </div>
