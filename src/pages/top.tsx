  ...
  return (
    <div className={`flex flex-col ${className}`}>
      <div className="mb-4 flex flex-col items-center justify-center">
        ...
        <h4 className="mt-4 text-xl font-medium">ChainMaster</h4>
      </div>
      ...
      <div className="flex h-44 w-72 flex-col items-center bg-gradient-to-b from-white/5 via-neutral-950/50 to-neutral-950/0 px-4 py-2 backdrop-blur-2xl">
        ...
        <h4 className="mt-3 text-sm">Earn 500 coins</h4>
  ...
  return (
    <div className="mx-auto mb-8 mt-24 flex max-w-screen-2xl flex-col items-center">
      <div className="mx-auto mb-12 rounded-2xl bg-neutral-950/30 p-2 backdrop-blur-2xl">
        <button className="rounded-2xl bg-neutral-950/50 px-12 py-3 backdrop-blur-2xl">
          Players
        </button>
        <button className="rounded-2xl px-12 py-3 hover:bg-neutral-950/50">
          Empires
        </button>
      </div>
      ...
      <div className="mt-12 max-w-2xl rounded-3xl bg-neutral-950/40 px-6 py-4 backdrop-blur-3xl">
        ...
        today and are ranked - out of <b>13.000 users</b>
      </div>
      ...
      <div className="mt-24 w-full max-w-screen-xl">
        <div className="flex flex-col">
          ...
          <ul className="flex w-full flex-col gap-y-4">
            <li className="grid grid-cols-4 rounded-xl bg-neutral-900/40 px-6 py-4 backdrop-blur-3xl">
              ...
              <div className="col-span-1 flex items-center gap-1">156</div>
              <div className="col-span-1 flex items-center gap-1">
