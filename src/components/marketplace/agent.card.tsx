...
export function AgentCard({ index }) {
  return (
    <div className="relative flex flex-col px-6 py-4 bg-neutral-900/20 backdrop-blur-xl border border-violet-500/10 rounded-2xl group hover:bg-neutral-800/50 transition">
      <img
        loading="lazy"
      ...
      <div className="flex items-center justify-between mt-4">
        <h3 className="font-medium font-inter text-neutral-200">
          Green Eyes Samurai
        </h3>
      ...
      <div className="flex items-center justify-between mt-6">
        ...
        <button className="ml-auto px-6 py-2 bg-violet-500 hover:bg-violet-600 rounded-xl">
          Buy Now
        </button>
      </div>
    </div>
