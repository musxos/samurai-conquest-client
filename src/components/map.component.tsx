...
function setup ()
{
    ...
    function onMouseMove (event: MouseEvent)
    {
        ...
        var intersects = raycaster.intersectObjects(scene.children, true).filter((x) => x.object.name == 'side')
    ...
    function init ()
    {
        ...
        const cloud = (cloudMesh = new THREE.Mesh(cloudPlaneGeometry, cloudPlaneMaterial))
        cloud.name = 'cloud'
        cloud.position.set(Math.random() * 800 - 400, 300, Math.random() * 800 - 400)
