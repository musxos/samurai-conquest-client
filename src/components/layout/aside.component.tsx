...
export function Aside() {
  ...
  return (
    <>
      <aside className="sticky top-0 w-16 h-screen bg-neutral-950/10 flex flex-col items-center px-4 py-6 z-50 backdrop-blur-lg border-r border-r-violet-500/20 text-neutral-600">
        <Link
      ...
      {modal && (
        <div
          className={classNames(
            'absolute h-full transform transition-all right-0 top-0 z-50',
            {
              'translate-x-0': modal,
