...
export function Navbar ({ className }: NavbarProps)
{
    ...
    return <nav className={`flex justify-between max-w-full h-14 ${className}`}>
        {layout.search && <div className="flex items-center rounded-xl bg-neutral-800 px-4 lg:px-6">
        ...
        <div className="flex gap-2">
            {layout.wallet && <div className="h-14 px-4 lg:px-6 flex items-center bg-neutral-800 rounded-xl">
            ...
            {layout.profile && <button className="px-6 py-3 h-14 bg-neutral-800 hover:bg-neutral-700 rounded-xl transition hidden lg:block">
                ChainMasterTR
            </button>}
        </div>
    </nav>
